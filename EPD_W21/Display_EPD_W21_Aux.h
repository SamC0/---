...
#define EPD_W21_MOSI_0	GPIO_ResetBits(GPIOA, GPIO_Pin_10)
#define EPD_W21_MOSI_1	GPIO_SetBits(GPIOA, GPIO_Pin_10)

#define EPD_W21_CLK_0	GPIO_ResetBits(GPIOA, GPIO_Pin_9)
#define EPD_W21_CLK_1	GPIO_SetBits(GPIOA, GPIO_Pin_9)
...
#define isEPD_W21_BUSY GPIO_ReadOutputDataBit(GPIOB, GPIO_Pin_13) 
